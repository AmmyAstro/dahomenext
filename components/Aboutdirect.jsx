...
export default function Aboutdirect() { 
  return (
    ...
    <div className="relative py-5 px-0 items-center justify-center flex flex-col md:flex-row  gap-6 z-10">
      ...
      <div className="director-box flex flex-col ">
        ...
        <p className="text-sm text-[#000]">At Dhwani Astro, we believe astrology is more than just a practice—it’s a guiding force
          ...
          — <span className=" text-[#2f1254] text-base md:text-xl  font-semibold">Niraj Jain</span></p>
        <div className="img-text-legacy flex items-start gap-5">
          ...
          <span className="flex flex-col">
            ...
            <span className=" text-[#2f1254] text-base md:text-xl">With Horoscope, Kundali, And Predictions</span>
          </span>
        </div>
      </div>
