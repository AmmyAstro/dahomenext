  ...
  return (
    ...
    <div
      ...
      <div className="image-da w-full md:w-1/5 justify-self-center">
        <Image src="/ds-img/logo.webp" alt="about us image" className="w-43 h-15 md:w-200 md:h-22 justify-self-center" unoptimized
          width={200} height={200} />
      </div>
      <div className="about-con flex flex-col w-full md:w-2/5">
        <h5 className="text-[#ffd70a] text-xl font-semibold">About Us</h5>
        <p className="text-[#fff] text-xs md:text-base">Dhwani Astro is India's most renowned astrology consultancy
      ...
      <div className="subsc-mail flex flex-col w-full md:w-2/5 gap-1 md:gap-5 place-self-start">
        <h5 className="text-[#fff] text-sm md:text-xl">SUBSCRIBE TO OUR NEWSLETTER</h5>
        <p className="text-[#fff] text-sm md:text-xl">Get Astrology Updates delivered to your doorstep.</p>
