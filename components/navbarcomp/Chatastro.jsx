...
export default function Chatastro() {
  ...
  return (
    <section className=" relative p-2 sm:p-5 flex w-full flex-col items-center self-center ">
      ...
      <div className="avail-bal-rech flex items-center justify-between gap-5  border-purple-500 rounded-lg p-0">
          <div className="avail-bal">
            <h5 className="text-[#000] flex items-center text-sm"><FaWallet className="text-xl"/> &nbsp; : ₹ 0.00 </h5>
          </div>
        ...
        <div className="filter-sort-search flex items-center justify-between gap-5">
          ...
          <div className="fixed z-999999 bottom-0 left-0 md:relative filter-items bg-[#2f1254] p-2 py-3 w-full md:bg-transparent flex items-center justify-between gap-5">
          ...
          <div className="search-astro h-[2.2rem] w-[10rem] flex items-center gap-1 px-5 rounded-full border border-green-600">
            <input
              type="text"
              placeholder="Search by Name"
              className="w-full text-[#000]  px-1  text-sm sm:text-md outline-none border-none rounded-full placeholder:text-xs"
            />
      ...
      <section className="chatastro-cards-main  items-center flex-wrap gap-3 sm:gap-5 grid grid-cols-2 sm:grid-cols-3 justify-around sm:w-[90%] w-[100%]">
        {chatastro.map((chatas, index) => (
          <Link href="#" key={index}>
            <div
              className="relative h-80 md:h-47  w-full p-1 sm:p-3 rounded-lg overflow-hidden shadow-lg bg-cover bg-center back-astro-image"
          ...
          <div className="celeb-tag absolute -rotate-45 top-2 left-[-30] z-99999">
            <span className="bg-[#ffd70a] p-1.5 text-[9px] text-[#000] w-30 inline-block  px-8">{chatas.celeb}</span>
          </div>

              <div className="relative h-[100%] p-2 flex rounded-lg justify-center items-center text-white bg-[#6a5781a1]">

                <div className="astro-image-price-box flex flex-col md:flex-row items-center justify-between gap-2 md:gap-5">

                  <div className="astro-image-name flex flex-col place-self-center items-center justify-between gap-1 sm:gap-2">
                    <Image
                      src={chatas.src}
                      className="w-22 h-22 sm:w-25 sm:h-25 rounded-full border-4 border-yellow-400 shadow-md object-cover"
                      width={50}
                      height={50}
                      loading="lazy"
                      alt={chatas.alt}
                  ...
                  <div className="astrologer-price-skill p-2 bg-[#00000880]   rounded-lg flex flex-col items-center justify-center">
                    ...
                    <div className="astrologer-price-box flex items-center justify-center w-full pb-2">
                      <p className="mt-2 text-[10px] sm:text-xs font-semibold flex gap-3 items-center justify-center">
                        <span>Chat : ₹ {chatas.prct}/min</span>
