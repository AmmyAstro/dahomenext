  ...
  return (
    <div className="home-puja-section flex flex-col items-center justify-center relative w-full mx-auto py-10">
      ...
      <div className="puja-section-main-home flex flex-col items-center justify-center">
        <h1 className="relative text-[#fff] bg-[#00000880] rounded-lg p-3 text-md sm:text-4xl mx-4 sm:mx-0 text-center font-semibold">
          •
          <strong>
          ...
          {pujasku.map((pujali) => (
            ...
            >
              <Image
                ...
                unoptimized
              />
              <h3 className="text-[10px] sm:text-base font-semibold text-[#fff]">
                {pujali.ulname}
              </h3>
            </div>
          ))}
