...
const categories = [
  { id: 0, name: "weekly Life", icon: "/ds-img/user2.png", content: "Your personal relationships are highlighted by today's celestial alignments..." },
  ...
  return (
    <div className="zod-life-det">
                ...
                <div className="luck-box flex items-center justify-between">
                    ...
                    <div
                        ...
                        <div className="col-luck">
                            <span className="text-[#000] text-sm"> 9,8,7</span>
                        </div>
                    </div>
                    <div
      ...
      <div className="car-swn-zod-det position-relative mt-4">
        <div className="horoscope_single_box rounded-lg border-2 border-fuchsia-300 p-3">
