...
const categories = [
    { id: 0, name: "yesterday Life", icon: "/ds-img/user2.png", content: "Your personal relationships are highlighted by today's celestial alignments..." },
    ...
    return (
        <div className="zod-life-det">
                ...
                <div className="luck-box flex items-center justify-between">
                    ...
                    <div
                        ...
                        <div className="col-luck">
                            <span className="text-[#000] text-sm"> 9,7,1</span>
                        </div>
                    </div>
                    <div
                        ...
                        <div className="col-luck">
                            <span className="text-[#000] text-sm"> W , R , Y</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                {categories.map((category) => (
                    <div key={category.id} className="zod-det-mob-card">
                        <p
                            ...
                            className={`bg-gradient-to-r from-[#8d5c9c8b] to-[#5a35b3aa] flex items-center justify-center w-48  py-2 rounded-lg gap-2 cursor-pointer transition-all ${activeCategory === category.id ? "border border-white shadow-lg" : ""
                                }`}
                        >
            ...
            <div className="car-swn-zod-det position-relative mt-4">
                <div className="horoscope_single_box rounded-lg border-2 border-indigo-400 p-3">
