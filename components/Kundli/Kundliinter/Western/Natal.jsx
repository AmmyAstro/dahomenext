                ...
                <div className="basic-kundli-charts col-span-3 flex flex-col gap-2 items-center">
                    ...
                    <section className="basic-details-main">
                        <div className="flex  gap-5 flex-col">
                            ...
                            <div className="natal-cusps-rep flex flex-col">
                                    ...
                                    {natalarr.map((natal,index) => (
                                        <div key={index} className="zod-det-mob-card">
                                            <p
                                                ...
                                                className={`bg-gradient-to-r from-[#ffffff] to-[#c998eff4] flex items-center border text-[#000] rounded-lg shadow-lg justify-center md:w-48 w-38  py-2  gap-2 cursor-pointer transition-all ${activeNatal === natal.id
